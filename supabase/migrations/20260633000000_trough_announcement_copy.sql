-- Trough funded-announcement copy: rewards pay snouts + leaderboard score
-- (20260628), not bankable tickles — the announcement body still promised
-- "Claim your tickles!" (Matchy walkthrough #11 / tracker #9). Body carried
-- verbatim from 20260627 apart from that one string.
