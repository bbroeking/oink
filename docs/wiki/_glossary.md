...
- **Judgement Day** — The Season 0 finale moment fired by `finalize_season`, now scheduled by a live `pg_cron` job at noon UTC on July 15. → [[seasons-and-judgement-day]]
...
- **Season** — The time-boxed competitive arc (Season 0 = Goblins vs Angels, Season 1 = The Great Hunger) that builds toward Judgement Day. → [[seasons-and-judgement-day]]
