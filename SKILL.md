...
- **2026-06-25 — Barn visits get a random 3–7 tap cap and an independent 3-hour per-friend cooldown (no daily cap).** Serves *Connect* + *Cooperate*: a visit stays a genuine, repeatable little ritual instead of a farmable grind, and closing the re-entry exploit keeps the social loop fair for everyone — while dropping the daily cap keeps it generous, not stingy. Cozy, not grindy.
