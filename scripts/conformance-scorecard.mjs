...
const AREAS = [
  ...
  ["B · Friends / Social / Sounder", /^(app\/\(tabs\)\/friends|components\/Friends|components\/UserSheet|components\/Inbox|components\/FriendInvitePicker|components\/PlayerInvitePicker|components\/BlockedUsersSheet|app\/sounder|components\/SounderCard|components\/SounderOinkSheet|components\/JoinableSounders|components\/TransferLeadershipSheet|app\/lounge\.tsx|app\/porch-round|components\/PorchRoundLaunchCard)/],
  ...
  ["D · Shop / Collect / Rewards", /^(app\/\(tabs\)\/shop|components\/ClosetView|components\/ItemPreviewModal|components\/PigPenView|components\/PigFriendsLaunchModal|components\/TroughSection|components\/LuckyPigModal|components\/MysteryHatReveal|app\/achievements|components\/AchievementDigestModal|components\/TitlesSection|app\/rosie-gallery|app\/mote-machine\.tsx|components\/mote-machine\/|app\/ad-refill-preview|features\/rewarded-ads\/)/],
